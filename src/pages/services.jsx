...
import servicehero from "../assets/serviceshero.mp4";
    ...
    <div className={`w-full min-h-screen ${theme === 'dark' ? 'bg-black text-white' : 'bg-white text-black'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className={`max-w-6xl mx-auto py-16 px-4 space-y-16 ${theme === 'dark' ? 'bg-[#181818]' : ''}`}>
        {t.services.map((service, index) => (
          ...
          >
            ...
            <div 
              className="w-full md:w-1/2 flex flex-col items-start justify-center md:pl-8"
              data-aos="slide-right"
              data-aos-duration="1000"
            >
              <h3 
              ...
              <p 
                className={`text-lg leading-relaxed ${theme === 'dark' ? 'text-white' : 'text-gray-700'}`}
                data-aos="fade-up"
                data-aos-delay="400"
              >
                {service.desc}
      ...
      <section className={`max-w-6xl mx-auto py-16 px-4 ${theme === 'dark' ? 'bg-black' : ''}`}>
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <ul 
              className={`list-disc list-inside text-lg space-y-3 ${theme === 'dark' ? 'text-white' : 'text-gray-700'}`}
              data-aos="fade-up"
              data-aos-delay="400"
            >
      ...
      <section className={`max-w-full mx-auto py-16 px-4 grid md:grid-cols-2 gap-12 items-center ${theme === 'dark' ? 'bg-[#181818]' : 'bg-gray-50'}`}>
        ...
        >
          ...
          <p 
            className={`text-lg mb-4 leading-relaxed ${theme === 'dark' ? 'text-white' : 'text-gray-700'}`}
            data-aos="fade-up"
            data-aos-delay="400"
          >
            {t.exploreDesc1}
      ...
      <section className={`py-16 px-4 ${theme === 'dark' ? 'bg-black' : 'bg-white'}`}>
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p 
            className={`text-lg mb-6 ${theme === 'dark' ? 'text-white' : 'text-gray-700'}`}
            data-aos="fade-up"
            data-aos-delay="200"
          >
            {t.contactDesc}
